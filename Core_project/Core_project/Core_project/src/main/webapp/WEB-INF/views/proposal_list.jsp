...
<body>
	<div class="wrapper">
		...
		<div class="main_banner">
			...
			<a href="${pageContext.request.contextPath}/proposal_post"
				class="basic_btn"> 정책 제안하기 </a>
		</div>
		...
		<div class="tabs">
			<c:forEach var="cat" items="${categories}">
				<a
					...
					class="tab ${cat == selectedCategory ? 'active' : ''}"> <span>${cat}</span>
				</a>
			</c:forEach>
		</div>
    ...
    <a href="${pageContext.request.contextPath}/proposal_detail?id=${p.PRPSL_NO}"
       class="search_box">
        ...
        <div class="search_box_content">
            <span class="search_box_content_title">${p.TITLE}</span>
