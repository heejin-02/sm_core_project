  ...
  <div id="wrapper">
    ...
    <div class="search_banner">
      <div id="title">
        ...
        <p class="banner_body">
          내 아이디어를 검색해 실제 정책 / 제안된 정책과의 유사도를 확인해보세요!
        </p>
      </div>
      <div id="search">
        <form action="${pageContext.request.contextPath}/similar_search"
          ...
          <input class="search_bar"
                 ...
                 value="${param.idea != null ? param.idea : ''}" />
            ...
            <c:forEach var="item" items="${similarList}">
              <div class="search_box">
                ...
                <div class="search_box_header">
                  <span class="category">${item.analysisModel}</span>
                  <span class="similarity">유사도 ${item.similarity}%</span>
                </div>

                <%-- 분석일, 분석 결과, 추천 정책 --%>
                <div class="search_box_content">
                  <p class="search_box_content_date">
                    <fmt:formatDate value="${item.analizedAtDate}"
                                    pattern="yyyy.MM.dd"/> 분석일
                  </p>
                ...
                <div class="search_box_proponent">
                  ...
                  <span class="search_box_proponent_name">
                    제안번호 ${item.prpslNo}
                  </span>
                </div>
              </div>
